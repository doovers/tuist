defmodule TuistWeb.Marketing.MarketingAgenticQaLive do
  @moduledoc false
  ...
  def handle_params(_params, _url, socket) do
    {:noreply,
     socket
     |> assign(:head_title, dgettext("marketing", "Agentic QA · Tuist"))
     |> assign(:head_include_blog_rss_and_atom, false)
     |> assign(:head_include_changelog_rss_and_atom, false)
     |> assign(:head_twitter_card, "summary_large_image")
     |> assign(
       :head_image,
       Tuist.Environment.app_url(path: "/marketing/images/og/agentic-qa.jpg")
     )
     |> assign(
       :head_description,
       dgettext(
