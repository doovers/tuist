defmodule TuistWeb.Marketing.FeaturePage do
  @moduledoc false

  defmacro __using__(opts) do
    title = Keyword.fetch!(opts, :title)
    og_image = Keyword.fetch!(opts, :og_image)
